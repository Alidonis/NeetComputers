...
public record ComputerScreenInitPayload(Object graphics, UUID uuid, UUID playerId)  implements CustomPayload {
    ...
    public static final PacketCodec<RegistryByteBuf, ComputerScreenInitPayload> CODEC = PacketCodec.of((value, buf) -> {
        ...
        public ComputerScreenInitPayload decode(RegistryByteBuf buf) {
            return new ComputerScreenInitPayload(SectoredGraphics.decodeFromPacket(buf), buf.readUuid(), buf.readUuid());
        }
